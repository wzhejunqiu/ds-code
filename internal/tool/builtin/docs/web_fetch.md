...
源文件：`web_fetch.go`、`web_fetch_policy.go`
...
- `internal/tool/builtin/web_fetch_policy.go`
- `internal/tool/builtin/web_fetch_test.go`、`web_fetch_policy_test.go`
- `internal/tool/display.go` — `FormatWebFetchDisplay`
