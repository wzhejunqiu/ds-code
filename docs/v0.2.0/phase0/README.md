...
phase0 是桌面产品线的**第一个可运行切片**，目标是验证技术栈可行性与核心桥接契约，**不追求完整产品功能**。
...
完整产品/架构设计见总纲 [spec/](../spec/)；本阶段仅实现其中 M0 切片。

## 文档索引

| 文档 | 说明 |
| ---- | ---- |
| [REQUIREMENTS.md](REQUIREMENTS.md) | 本阶段 scoped 功能需求（引用总纲 FR 编号） |
| [DESIGN.md](DESIGN.md) | 本阶段实现焦点与增量设计要点 |
| [ACCEPTANCE.md](ACCEPTANCE.md) | 本阶段 gate 验收标准 |
| [spec/](../spec/) | **完整产品/架构总纲** |
...
[phase1](../phase1/) — M1 桌面 MVP（多 workspace + 三栏 + 完整 P0 功能）
